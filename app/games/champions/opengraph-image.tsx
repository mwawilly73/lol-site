  ...
  try {
    return new ImageResponse(
      (
        ...
        >
          {/* halos (radial seulement) */}
          <div
            style={{
              position: "absolute",
              inset: 0,
              background:
                "radial-gradient(60% 45% at 50% 22%, rgba(99,102,241,.26), rgba(6,182,212,.16) 45%, rgba(0,0,0,0) 80%)",
            }}
          />
          <div
            style={{
              ...
              borderRadius: 999,
              background:
                "radial-gradient(60% 60% at 50% 50%, rgba(168,85,247,.22), rgba(0,0,0,0) 70%)",
            }}
          />
